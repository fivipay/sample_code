...
public class Card extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		String accessKey = ""; // access key do fivipay cung cap. Thay bang access key san pham cua ban
		String secretKey = ""; // secret key do fivipay cung cap. Thay bang secret key san pham cua ban
	...
	private void sendPost(String access_key, String type, String pin,
		...
		String url = "https://api.fivipay.com/card-charging/v5/topup";
		URL obj = new URL(url);
